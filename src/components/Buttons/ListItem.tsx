...
export const ListItem = forwardRef(
    ({text, icon, rootClassName, active, onClick, optionalText, style, iconOnly = false}: {
        text: string,
        ...
        return (
            <div
                ...
                {!iconOnly && (
                    <div
                        className={` flex flex-col text-left  whitespace-nowrap ${active && "font-bold text-dark_primary"}`}>
                        <span>{text}</span>
